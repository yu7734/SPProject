...
public class StarScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        transform.parent = GameObject.Find("StarScrollManager").transform;//stageを変更する時にSestroy(this.gameObject)する必要あり
    }
    void Update()
    {
        ...
        transform.Translate(new Vector3(0f, 0f, -1f) * 50f * Time.deltaTime);//上記と同様
